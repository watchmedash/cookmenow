...
<!--<div class="discontent"><h3>Choose server:</h3></div>
  ...
  <div class="custom-tab" onclick="switchVideo('server3', 'video-player', 'https://multiembed.mov/directstream.php?video_id=tt6791350')">Streamify</div>
   -->
...
<script>
    ...
    (function() { // DON'T EDIT BELOW THIS LINE
        ...
        s.src = 'https://watchmenow.disqus.com/embed.js';
